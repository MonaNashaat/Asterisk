...
class GoldLabelKey(AnnotationKeyMixin, AsteriskBase):
    pass


class LabelKey(AnnotationKeyMixin, AsteriskBase):
    pass


class FeatureKey(AnnotationKeyMixin, AsteriskBase):
    pass


class PredictionKey(AnnotationKeyMixin, AsteriskBase):
    pass
...
class AnnotationMixin(object):
    ...
    .. code-block:: python
        ...
        from Asterisk.models.annotation import AnnotationMixin
        from Asterisk.models.meta import AsteriskBase

        class NewAnnotation(AnnotationMixin, AsteriskBase):
...
class GoldLabel(AnnotationMixin, AsteriskBase):
    """A separate class for labels from human annotators or other gold standards."""
    value = Column(Integer, nullable=False)


class Label(AnnotationMixin, AsteriskBase):
    """
...
class Feature(AnnotationMixin, AsteriskBase):
    """
...
class Prediction(AnnotationMixin, AsteriskBase):
    """
...
class StableLabel(AsteriskBase):
    """
